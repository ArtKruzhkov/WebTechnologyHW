...
$name = "Fred";
$prof = "FrontEndDev";
$country_city = "Spain_Madrid";
$email = "fredfrontend@gmail.com";
$phonenum = "34786657321";
...
//HomeWork
$workexparrname = "Work Experience";
$WorkExp = [
    [
    ...
    [
        'WorkPosition' => 'Web Developer / something.com',
        'DateStart' => 'Mar 2012',
        'DateEnd' => 'Dec 2014',
    ...
    [
        'WorkPosition' => 'Graphic Designer / designsomething.com',
        'DateStart' => 'Jun 2010',
        'DateEnd' => 'Mar 2012',
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i><?= $country_city ?></p>
            <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i><?= $email ?></p>
            <p><i class="fa fa-phone fa-fw w3-margin-right w3-large w3-text-teal"></i><?= $phonenum ?></p>
            <hr>
 
            <p class="w3-large"><b><i class="fa fa-asterisk fa-fw w3-margin-right w3-text-teal"></i><?= $skillsarrayname ?></b></p>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <h2 class="w3-text-grey w3-padding-16"><i
              class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i><?=$workexparrname ?></h2>
         <?php for ($i = 0; $i < count($WorkExp); $i++): ?>
            <div class="w3-container"> 
              ...
              <?php endif ?>
            <p><?php echo $WorkExp[$i]["Discription"] ?></p>
            <hr>
            </div>
          <?php endfor ?>
          <!-- HomeWork -->
